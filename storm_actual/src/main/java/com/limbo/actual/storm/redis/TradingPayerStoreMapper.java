...
public class TradingPayerStoreMapper implements RedisStoreMapper {

    private RedisDataTypeDescription description;

    public TradingPayerStoreMapper(){
    ...
    public String getKeyFromTuple(ITuple iTuple) {
        Person payer = JackJsonUtil.toBean(iTuple.getStringByField("payer_json"),Person.class);
        return payer.getName()+"_payer";
    }
